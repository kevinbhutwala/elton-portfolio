...
export const editTimelineStages = [
  ...
  },
  {
    ...
    desc: 'Tracking titles, optical blurs, glitch passes, HUD graphics, clean rotoscoping, and speed ramps linked via Dynamic Link.',
    color: '#9B51E0',
    ...
    lut: 'ACEScc COLOR SPACE',
    actionNote: 'Adding kinetic visual identity and graphic reinforcement',
  },
  {
    stage: '05',
    name: 'COLOR GRADE & FINISHING',
    software: 'Premiere Lumetri & DaVinci (Advancing)',
    desc: 'Dialing contrast ratios, skin tone preservation, custom cinematic film LUTs, and darkroom highlights for mood and atmospheric depth.',
    color: '#D4AF37',
    ...
    lut: 'KODAK_VISION3_WARM_TEAL',
    actionNote: 'Balancing shot-to-shot consistency and filmic color warmth',
  },
  {
    stage: '06',
