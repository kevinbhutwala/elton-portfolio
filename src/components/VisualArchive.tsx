...
const archivePhotos: ArchivePhoto[] = [
  ...
  },
  {
    ...
    title: 'Coconut Grove, Goa',
    category: 'Cinematics',
    iso: 'ISO 200',
    shutter: '1/250s',
    focal: '16mm Ultra-Wide',
    location: 'Coconut Grove, Goa',
    aspect: '3:4 Aspect',
  ...
  },
  {
    ...
    title: 'Gulf of Mannar Bay (Indian Ocean)',
    category: 'Cinematics',
    iso: 'ISO 100',
    shutter: '1/640s',
    focal: '24mm Wide Prime',
    location: 'Gulf of Mannar, Indian Ocean',
    aspect: '3:4 Aspect',
  ...
  },
  {
    ...
    title: 'Turtle Matcha, Bangalore',
    category: 'Lifestyle Still',
    iso: 'ISO 400',
    shutter: '1/120s',
    focal: '50mm F1.8 Prime',
    location: 'Turtle Matcha, Bangalore',
    aspect: '3:4 Aspect',
  ...
  },
  {
    ...
    title: 'Beige, Bangalore',
    category: 'Architectural',
    iso: 'ISO 125',
    shutter: '1/500s',
    focal: '18mm Ultra-Wide',
    location: 'Beige, Bangalore',
    aspect: '3:4 Aspect',
